// Create preview.png from HTML
const fs = require('fs');
const path = require('path');

// Create a simple SVG-based preview image
...
<svg width="1200" height="630" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Main Content -->
  <text x="600" y="280" font-family="Arial, sans-serif" font-size="120" font-weight="bold" text-anchor="middle" fill="white">🌤️ BGWeather</text>
  ...
  <text x="1000" y="580" font-family="Arial, sans-serif" font-size="20" fill="rgba(255,255,255,0.7)">bgweathers.netlify.app</text>
    ...
    fs.writeFileSync(path.join(__dirname, 'public', 'preview.svg'), svgContent);
    console.log('✅ Preview SVG created!');
    console.log('📁 Saved to: public/preview.svg');
    console.log('💡 Now you need to convert this to PNG manually or use online tools');
}
